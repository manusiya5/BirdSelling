...
function Bird3Cart(){
  ...
  useEffect(()=>{
    setPrice(count*16000);
  },[count]);
return(
  <div>
    <div className='bg-light'>
  <div >
  <Link to='/ThirdBirdDetails'><i class="arrow bi bi-arrow-left"></i></Link>
...
<div class="offcanvas offcanvas-end" id="demo" >
   ...
   <Row className='shadow-lg p-3 mb-5 bg-white rounded m-5'>
    <Col lg={7} sm={10}>
      ...
      <img className="cartimage" src='https://inaturalist-open-data.s3.amazonaws.com/photos/6178436/large.jpg' alt="jkdsf"></img>
    </Col >
        


    <Col className="cartDetails" lg={5} sm={2}>
    <h3>[1 pair]  BlLUE AND GOLD MACAW </h3>
       <h5 className='p-3'>₹16000.00 Only</h5>
