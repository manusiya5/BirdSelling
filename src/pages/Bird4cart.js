...
return(
  ...
  <div >
  <Link to='/FourthBirdDetails'><i class="arrow bi bi-arrow-left"></i></Link>
...
<div class="offcanvas offcanvas-end" id="demo" >
   ...
   <Row className='shadow-lg p-3 mb-5 bg-white rounded m-5'>
    <Col lg={7} sm={10}>
      ...
      <img className="cartimage" src='https://cdn.download.ams.birds.cornell.edu/api/v1/asset/123646521/1800' alt="jkdsf"></img>
    </Col >
        


    <Col className="cartDetails" lg={5} sm={2}>
    <h3>[1 pair]  ZEBRA FINCH BIRD </h3>
       <h5 className='p-3'>₹1650.00 Only</h5>
